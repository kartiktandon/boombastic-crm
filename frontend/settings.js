...
async function settingsPage() {
  ...
  document.querySelector("#settings-form").onsubmit = async event => {
    ...
    const payload = {business_name:data.get("business_name"),business_type:data.get("business_type"),business_email:data.get("business_email")||null,business_phone:data.get("business_phone")||null,website:data.get("website")||null,address:data.get("address")||null,timezone:data.get("timezone"),default_lead_owner:defaultAssignment.assigned_to,auto_assign_leads:data.has("auto_assign_leads"),followup_reminder_minutes:Number(data.get("followup_reminder_minutes")),inactivity_days:Number(data.get("inactivity_days")),notify_new_leads:data.has("notify_new_leads"),notify_followups:data.has("notify_followups"),notify_bookings:data.has("notify_bookings")};
    save.disabled = true;
